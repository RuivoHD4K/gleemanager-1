  ...
  return (
    <LoadingSpinner isLoading={loading}>
      <div className="admin-dashboard">
        ...
        {/* Main dashboard grid layout - all rows use the same 6-column grid */}
        <div className="dashboard-grid six-column-grid">
          {/* Top Row - App Drawer and Activity (50/50 split) */}
          {/* App Drawer - takes up 3 columns */}
          <div className="app-drawer-container grid-span-3">
          ...
          {/* Activity Card - takes up 3 columns */}
          <div className="dashboard-card activity-card grid-span-3">
          ...
          {/* Bottom Row - Online Users and Holiday Approval */}
          {/* Online Users - takes up four columns */}
          <div className="grid-span-4">
            <UsersList onlyShowOnline={true} />
          </div>
          
          {/* Holiday Approval Panel - takes up two columns */}
          <div className="dashboard-card holiday-approval-card grid-span-2">
